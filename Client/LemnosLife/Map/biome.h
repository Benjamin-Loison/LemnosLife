...
void loadBiomeChk1k(std::string, bool = false, bool encrypted = false), setBiome(double x, double y, std::string chk1kName, char biome); // for setBiome removed std::string chk1kName argument in order to be as near as possible to getBiome also done in GuiMap - reverse !
