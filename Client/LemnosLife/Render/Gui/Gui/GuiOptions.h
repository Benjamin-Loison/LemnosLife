...
private:
    void addBoolButton(std::string option, std::string toDisplay), addKeyButton(std::string option, std::string toDisplay), addDropDownButton(std::string option, std::string toDisplay),
         addRangeButton(std::string option, std::string toDisplay, unsigned short inputSize), resizeVariables(), onButton0Clicked(), onButton1Clicked(), onButton2Clicked(), onButton3Clicked(), onButton4Clicked(), onButton5Clicked();
