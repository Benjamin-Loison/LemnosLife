...
{
public:
    Radio(std::vector<std::string>, unsigned short, unsigned short = 41/*using a macro would involve more modularity*/, bool = false, bool = false, bool = false);
    void resize(double, double, double, double, double), render(), init(std::vector<std::string>), scroll(double wheel); // init used to be private
