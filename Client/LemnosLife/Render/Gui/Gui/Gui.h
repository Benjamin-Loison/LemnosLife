...
extern SDL_Color white, whiteTransparent, grey, lightGrey, darkGreyTransparent, greyTransparent, lightGreen, blue, black, red, redTransparent, green, darkGreenTransparent, orangeTransparent, lightBlue, beige, darkBeige, yellow;
...
void glBasics(),
     ...
     setGuiInGame(std::string, bool isShop = false, bool isVehicle = false),
     ...
     displayLine(double x0, double y0, double x1, double y1, SDL_Color color),
     ...
     displayText(std::string, double, double, double, double, std::string = "arial", SDL_Color = white, bool = false, double = 1),
