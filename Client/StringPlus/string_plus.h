...
std::string replace(std::string, const std::string&, const std::string&), replaceAll(std::string, const std::string&, const std::string&), toString(SDL_Color), toString(bool), toString(std::vector<std::string>), toString(Vector3D);
