...
std::string replace(std::string, const std::string&, const std::string& = ""), replaceAll(std::string, const std::string&, const std::string& = ""), toString(SDL_Color), toString(bool), toString(std::vector<std::string>), toString(Vector3D, std::string = " "),
            ...
            toString(std::vector<Vector2D>, std::string delimiter = ";", std::string vector2DDelimiter = " ");
int convertStrToInt(std::string);
double convertStrToDouble(std::string);
bool isANumber(std::string), isADouble(std::string), isAnInteger(std::string), isAnInteger(double), isAlphabetic(char), isAlphabetic(std::string), startsWith(std::string, std::string), endsWith(const std::string&, const std::string&),
     ...
     isOnly(std::string, char);
long long convertStrToLongLong(std::string);
std::map<std::string, std::string> toString(std::map<std::string, bool>), toString(std::map<std::string, double>), toString(std::map<std::string, long long>);
